...
const BattleOfRoots = () => {
  ...
  return (
    ...
    <form onSubmit={handleSubmit} className="flex items-center m-4 p-4">
      <select name="place1" required onChange={onChangeHandler} className="mr-20 border border-solid border-blue-500">
      ...
      <select name="place2" required onChange={onChangeHandler} className="ml-20 border border-solid border-blue-500">
    ...
    {(twoArrayChampions.place1Champions && twoArrayChampions.place2Champions) && <DisplayChampions champions1={twoArrayChampions.place1Champions} champions2={twoArrayChampions.place2Champions} />}
  </div>
  )  
}
